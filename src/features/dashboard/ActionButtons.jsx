...
const ActionButtons = ({ onSend, onReceive, onSwap, onScan }) => {
  ...
  return (
    <div className="mt-8 sm:mt-18 flex justify-center sm:justify-start">
      <div className="grid grid-cols-4 gap-3 sm:gap-8 w-full max-w-xs sm:max-w-sm">
        {actions.map((action, i) => {
          ...
          return (
            ...
            >
              <div
                className={`w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-[20px] flex items-center justify-center transition-all duration-200 active:scale-90 ${action.primary
